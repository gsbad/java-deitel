...
public class StaticCharMethods {
    public static void main(String[] args) {
        // Métodos estaticos Character p testar caracteres e converter entre maiusculas e minusculas
        Scanner scanner = new Scanner(System.in);
        
        System.out.println("Entre com um caractere e pressione ENTER");
        String input = scanner.next();

        char c = input.charAt(0); //obtem o caracter de entrada

        // exibe informaçoes do caractere
        ...
        System.out.printf("is a part of java identifier: %b%n", Character.isJavaIdentifierPart(c));
